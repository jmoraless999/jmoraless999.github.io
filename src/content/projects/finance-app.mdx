...
---
// 1. Importas el componente nativo de optimización de Astro
import { Image } from 'astro:assets';

// 2. Importas la imagen local desde tu carpeta de código
import miGrafico desde '../src/assets/Imagen_3.png';
---

<Image src={miGrafico} alt="Crecimiento acumulado de ganancias por tienda" />
